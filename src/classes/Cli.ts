...
class Cli {
  ...
  createMotorbike(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        const wheels = [
          new Wheel(parseInt(answers.frontWheelDiameter), answers.frontWheetBrand),
        ...
        const motobike = new Motorbike(
          ...
          // push the motobike to the vehicles array
          this.vehicles.push (motobike);
          // set the selectedVehicleVin to the vin of the motobike
          this.selectedVehicleVin = motobike.vin;
          // perform actions on the motobike
          this.performActions();
        });
    }
  ...
  findVehicleToTow(): void {
    inquirer
      ...
      .then((answers) => {
       const selectedVehicleToTow = this.vehicles.find (
        ...
        if (selectedTruck instanceof Truck) {
          ...
          console.log(
            `${selectedTruck.make} ${selectedTruck.model} is towing ${selectedVehicleToTow?.make} ${selectedVehicleToTow?.model}`
          );
          this.performActions();
          }else{
